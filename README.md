...
| **Projet intégrateur:** |       |
| &nbsp;&nbsp;&nbsp;&nbsp;Chaine IoT: noeuds RPi Pico (microcontrôleur et capteur) à <ins>Streamlit (tableau de bord)</ins><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;via MQTT et MongoDB Atlas | <a href="https://github.com/ugolabo/chaine_iot_pico_streamlit">bouton droit vers repo</a> Voici le <a href="[https://github.com/ugolabo/chaine_iot_pico_streamlit](https://toucan-fortune-streamlit-projet-integrateur-01-accueil-0fsbkp.streamlit.app/)">tableau de bord Stremlit</a> |
